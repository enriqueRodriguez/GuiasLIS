...
<head>
    ...
    <title>Guias LIS</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <link href="css/styles.css" rel="stylesheet">
</head>

<body>
    <header class="full-width-header text-white text-center py-5 mb-4">
        <div class="container">
            <h1 class="font-weight-light">Guias LIS</h1>
        </div>
    </header>
            ...
            <div class="col-md-6">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <a href="Guia3/Ejemplo4/index.php" class="btn btn-secondary" target="_blank">Ejemplo 4</a>
