    ...
    <section id="container">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                echo "<div class='col-sm-6 py-5 px-lg-5 border bg-success'>El mayor de 58, 167, 242, 85, 31, 109, -26, 81, 16, 126 es: " . "<h2>" . elMayor(
                    58,
                    167,
                    242,
                    85,
                ...
                ?>
                <?php
                echo "<div class='col-sm-6 py-5 px-lg-5 border bg-warning'>El mayor de 61, 37, 75, 184, 42, -303, 43, 56, -121, 226, 172, 78, 6, 86 es:" . "<h2>" . elMayor(
                    61,
                    37,
                    75,
                    184,
