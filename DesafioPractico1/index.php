                ...
                <div id="backgroundCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/img/textile1.jpg" class="d-block w-100" alt="Textiles">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/promo1.jpg" class="d-block w-100" alt="Promocionales">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/textile2.jpg" class="d-block w-100" alt="Productos">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/textile3.jpg" class="d-block w-100" alt="Productos">
                        </div>
                    </div>
